...
| Doing a fast reviewer triage | [`security/reviewer-quickstart.md`](security/reviewer-quickstart.md) | [`examples/review-patterns.md`](examples/review-patterns.md) for safe/risky snippets, [`examples/risky-patterns.md`](examples/risky-patterns.md) for decision guidance, and [`examples/reviewer-evidence-packet.md`](examples/reviewer-evidence-packet.md) before the short [`examples/review-decision-note.md`](examples/review-decision-note.md) |
| Making a Security Reviewed decision | [`security/review-guide.md`](security/review-guide.md) | [`examples/reviewer-evidence-packet.md`](examples/reviewer-evidence-packet.md) for passing/blocking evidence packets, [`examples/review-decision-note.md`](examples/review-decision-note.md) for the PR or issue note, and [`security/trust-label-lifecycle.md`](security/trust-label-lifecycle.md) for label evidence |
