...
If that check finds an unsupported claim, copy the unsupported part and the exact author evidence needed into `Required follow-up` in the short [`Review Decision Note`](../examples/review-decision-note.md).
